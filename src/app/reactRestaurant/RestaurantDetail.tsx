...
interface RestaurantDetailProps{ //규칙, Props로 넘어오는 건 interface로 따로 빼기
  data:rest|undefined
}

export default async function RestaurantDetail({data}:RestaurantDetailProps) {
    ...
    <div className="bg-white rounded-lg overflow-hidden shadow-lg hover:shadow-2xl transition-shadow duration-300 ease-in-out">
        ...
        <div className="p-6">
          ...
          <p className="mt-1 text-gray-700 text-sm">{data.ITEMCNTNTS}</p>
